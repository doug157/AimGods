...
public:
	...
	unsigned char                                      UnknownData_OS31[0x6];                                     // 0x0292(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_MainMenu_Custom_Play.WB_MainMenu_Custom_Play_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WB_MainMenu_Custom_Play(int EntryPoint);
