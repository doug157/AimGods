...
{
	unsigned char                                      UnknownData_GKBA[0x30];                                    // 0x0108(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                  // 0x0138(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_U3S0[0x310];                                   // 0x0148(0x0310) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UGameplayEffect*>                     ApplicationImmunityQueryEffects;                           // 0x0458(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_DC5Y[0x18];                                    // 0x0468(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpecContainer
{
	...
	unsigned char                                      UnknownData_U6FT[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTagContainerAggregator
{
	...
	unsigned char                                      UnknownData_JG83[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RBJ0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpec
{
	...
	unsigned char                                      UnknownData_3SI1[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K52V[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U94P[0x3];                                     // 0x01C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilitySpecs;                                       // 0x01C8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4UBQ[0xA0];                                    // 0x01D8(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GGKX[0x4];                                     // 0x0294(0x0004) MISSED OFFSET (PADDING)
...
struct FPredictionKey
{
	...
	unsigned char                                      UnknownData_F9JN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OBDS[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X7GV[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_96ED[0x9B];                                    // 0x02D5(0x009B) MISSED OFFSET (PADDING)
...
struct FScalableFloat
{
	...
	unsigned char                                      UnknownData_OE31[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XW05[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData_43ZX[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XMZI[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M80W[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureDefinition
{
	...
	unsigned char                                      UnknownData_L35Q[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpec
{
	...
	unsigned char                                      UnknownData_T7SD[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
struct FActiveGameplayCueContainer : public FFastArraySerializer
{
	...
	unsigned char                                      UnknownData_SF4D[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_1R8C[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XKDJ[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MH91[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O2K1[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H7UA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0D4A[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FGameplayAbilities_FServerAbilityRPCBatch
{
	...
	unsigned char                                      UnknownData_8IGY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N1WQ[0x5];                                     // 0x004B(0x0005) MISSED OFFSET (PADDING)
...
struct FGameplayEffectModifiedAttribute
{
	...
	unsigned char                                      UnknownData_6QTY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O56H[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJ8S[0x10];                                    // 0x0128(0x0010) MISSED OFFSET (PADDING)
...
struct FGameplayTagReponsePair
{
	...
	unsigned char                                      UnknownData_X3J2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WB37[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ND4U[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QYXO[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P715[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J71U[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagBlueprintPropertyMapping
{
	...
	unsigned char                                      UnknownData_12PQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CVSL[0xF8];                                    // 0x0000(0x00F8) MISSED OFFSET (PADDING)
...
struct FGameplayEffectCustomExecutionOutput
{
	...
	unsigned char                                      UnknownData_78SN[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveGameplayEffectHandle
{
	...
	unsigned char                                      UnknownData_6SPV[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayModifierEvaluatedData
{
	...
	unsigned char                                      UnknownData_9XG6[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EMGN[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAttributeBasedFloat
{
	...
	unsigned char                                      UnknownData_2SIB[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifierMagnitude
{
	...
	unsigned char                                      UnknownData_3F7Y[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	TEnumAsByte<EGameplayModOp>                        ModifierOp;                                                // 0x0031(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_C9ZD[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QZ9D[0x7];                                     // 0x01C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayModifierInfo
{
	...
	unsigned char                                      UnknownData_236Q[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0M4W[0x7];                                     // 0x01D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_AKYV[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslationManager
{
	...
	unsigned char                                      UnknownData_SFGB[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslatorNode
{
	...
	unsigned char                                      UnknownData_SZ8X[0x54];                                    // 0x0024(0x0054) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslationLink
{
	...
	unsigned char                                      UnknownData_XANI[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FGameplayCueNotifyData
{
	...
	unsigned char                                      UnknownData_08RC[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayCueObjectLibrary
{
	...
	unsigned char                                      UnknownData_OQXR[0x20];                                    // 0x0010(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N21E[0x4];                                     // 0x0048(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0EDV[0x1B0];                                   // 0x0000(0x01B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7W79[0x8];                                     // 0x01B8(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5K82[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0018(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_0QT4[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7K0U[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KO7G[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_37UG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityEndedData
{
	...
	unsigned char                                      UnknownData_54VF[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M9DR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X9AJ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WHXX[0xF];                                     // 0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_VGDM[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_DF5P[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayAbilityTargetingLocationInfo       SourceLocation;                                            // 0x0010(0x0070) (Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
struct FGameplayAbilityTargetData_SingleTargetHit : public FGameplayAbilityTargetData
{
	...
	unsigned char                                      UnknownData_BYKC[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityBindInfo
{
	...
	unsigned char                                      UnknownData_DV3W[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityTriggerData
{
	...
	unsigned char                                      UnknownData_MP9N[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E6YV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_6X03[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LGEM[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEffectRemovalInfo
{
	...
	unsigned char                                      UnknownData_1SQR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilityLocalAnimMontage
{
	...
	unsigned char                                      UnknownData_09X6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0010(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      UnknownData_S7KP[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0018(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayAbilityActivationInfo
{
	...
	unsigned char                                      UnknownData_XLGV[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_VAQ9[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V1IZ[0x50];                                    // 0x0078(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3XZZ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SFQY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RGJ8[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W84Z[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEventData
{
	...
	unsigned char                                      UnknownData_OFCM[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5PTV[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
