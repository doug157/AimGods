...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GA_SliceAndDice_Damage.GA_SliceAndDice_Damage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GA_SliceAndDice_Damage(int EntryPoint);
};
