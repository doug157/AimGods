...
// 0x0100 (FullSize[0x08A0] - InheritedSize[0x07A0])
...
public:
	...
	unsigned char                                      UnknownData_5TZ8[0xC];                                     // 0x0834(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     DefaultFilmbackPresetName;                                 // 0x0860(0x0010) (ZeroConstructor, Config, Deprecated, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FString                                     DefaultFilmbackPreset;                                     // 0x0870(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FString                                     DefaultLensPresetName;                                     // 0x0880(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData_KGC8[0x8];                                     // 0x0898(0x0008) MISSED OFFSET (PADDING)
...
// 0x0060 (FullSize[0x07E0] - InheritedSize[0x0780])
...
public:
	...
	unsigned char                                      UnknownData_2V6J[0x10];                                    // 0x07D0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DJ2T[0x3];                                     // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_H1J8[0x2];                                     // 0x0226(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
